 ...
 */
final class Version20181027084222 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD page_description LONGTEXT DEFAULT NULL, ADD keywords LONGTEXT DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE firm ADD page_description LONGTEXT DEFAULT NULL, ADD keywords LONGTEXT DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE firm DROP page_description, DROP keywords, CHANGE description description VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
        $this->addSql('ALTER TABLE product DROP page_description, DROP keywords, CHANGE description description LONGTEXT DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
